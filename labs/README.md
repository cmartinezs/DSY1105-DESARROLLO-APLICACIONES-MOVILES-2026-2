...
El `README.md` de cada lab actúa como portada e índice. Debe contener:

1. propósito del laboratorio;
2. objetivos;
3. resultado esperado;
4. contenidos de la semana aplicados;
5. conocimientos previos;
6. dependencia de labs anteriores: `ninguna` o referencia explícita;
7. requisitos técnicos;
8. secuencia de archivos del laboratorio;
9. criterio de finalización.

Los pasos de implementación deben repartirse en varios Markdown cuando el lab cubra más de una materia o etapa. Un único `README.md` largo no es el formato deseado.
